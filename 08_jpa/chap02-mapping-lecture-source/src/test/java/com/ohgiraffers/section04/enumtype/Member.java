...
public class Member {
    ...
    @Column(name="member_role") //enum 으로 변환 이름자체와 순번으로 이넘데이터 db에 저장 가능
//    @Enumerated(EnumType.ORDINAL) //ORDINAL - 숫자로 들어감( ex: 0 또는 1)
    @Enumerated(EnumType.STRING) // STRING - 문자가 들어감 ( ex. ADMIN 또는 MEMBER)
