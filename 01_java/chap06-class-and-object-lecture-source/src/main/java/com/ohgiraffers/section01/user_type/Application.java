...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 설명.
        *   회원 정보를 관히하기 위해 회원의 여러정보( 아이디, 비밀번호, 이름,나이
        ...
        *   2. 메소드의 전달인자로 전달 할 값이 너무 많아 회원과 관련된 기능을 호출할때 매개변수가 많아진다.(나쁜냄새)
        ...
        * */
        ...
        System.out.println("개명이 됐는지 확인: " + returnValue);
        System.out.println("개명이 됐는지 확인: " + member.name);
        System.out.println("개명이 됐는지 확인: " + returnValue.name);
    }
